        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 mb-3">
                ...
                <div class="container row text-center">
                    ...
                    <div class="form-group col-sm-6">
                        <p class="h4 text-primary">Pajak: {{ Cart::tax() }}</p>
                    </div>
                    <div class="form-group col-sm-6">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-12 mt-4">
                            <div class="d-flex flex-wrap align-items-center justify-content-center">
                                <a href="{{ route('customers.create') }}" class="btn btn-primary add-list mx-1">Buat
                                    Customer baru</a>
                                <button type="submit" class="btn btn-success add-list mx-1">Pembayaran</button>
                            </div>
                        </div>
                    </div>
                </form>
